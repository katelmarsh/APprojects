                      ...
                      implements ActionListener
{
  ...
  public SnackBar()
  {
    ...
    Color brandColor1 = new Color(199, 21, 133); // r, g, b
    Color brandColor2 = new Color(102, 204, 255);
    Color brandColor3 = new Color(204, 153, 255);

    VendingMachine[] machines =
    {
      new VendingMachine("Twix", brandColor2, 45, coin),
      new VendingMachine("KitKat", brandColor3, 50, coin),
      new VendingMachine("MilkyWay", brandColor1, 35, coin)
    };
